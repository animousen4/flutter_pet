...
class ThemeDataScope extends StatefulWidget {
  ...
  static ThemeDataController of(BuildContext context) => context.inheritOf<_ThemeDataInh>(listen: false)!.themeDataController;

  
}

class _ThemeDataScopeState extends State<ThemeDataScope> implements ThemeDataController {
  late ThemeData themeData;

  @override
  Widget build(BuildContext context) {
    return _ThemeDataInh(themeData: themeData, themeDataController: this, child: widget.child,);
  }
...
class _ThemeDataInh extends InheritedWidget {
  const _ThemeDataInh({required super.child, required this.themeData, required this.themeDataController});
